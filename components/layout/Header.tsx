    ...
    <div className="flex items-center justify-between p-4 md:p-6 sticky top-0 z-10 bg-white/80 dark:bg-[#131314]/80 backdrop-blur-md border-b border-gray-200 dark:border-white/5 md:border-none transition-colors duration-300">
      <div className="flex items-center gap-3">
         ...
         <div className="flex items-center gap-2">
            <span className="text-xl font-semibold text-gray-800 dark:text-gray-200">Gemini Crypto</span>
            <span className="px-2 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 text-xs rounded-md border border-blue-200 dark:border-blue-800/50 hidden sm:inline-block">2.5 Flash</span>
         </div>
      </div>
